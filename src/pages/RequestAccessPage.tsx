...
export function RequestAccessPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    if (!c) return alertMissing("Company is required.");
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-xl mx-auto">
        ...
        {!loadingMyRequest && myRequest?.status === "PENDING" ? (
          <div className="mt-6 rounded-lg border bg-card p-4 text-sm">
            ...
            <div className="text-muted-foreground mt-1">
              Submitted {new Date(myRequest.createdAt).toLocaleString()}. You’ll be able to access the platform once an admin assigns your role and company.
            </div>
        ...
        {!loadingMyRequest && myRequest?.status === "PENDING" ? null : (
          ...
          <div className="space-y-2">
            ...
            <Input value={company} onChange={(e) => setCompany(sanitizeWordsOnly(e.target.value))} placeholder="Company name" />
          </div>
